...
{
    public static class clsApplictionsTypeData
    {
        static public DataTable GetApplictionTypes()
        {
            ...
            string Qeury = "select * from ApplicationTypes order by ApplicationTypeTitle";
        ...
        static public bool GetApplicationTypeByID(byte ID, ref string Title, ref float Fee)
        {
