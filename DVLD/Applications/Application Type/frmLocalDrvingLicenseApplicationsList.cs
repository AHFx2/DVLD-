...
namespace DVLD_Interface.Screens.MISC
{
    public partial class frmLocalDrvingLicenseApplicationsList : Form
    {
        ...
        private void _LoadDataGridView(string Condition = "")
        {

            LocalApplicationsTable = DVLD_Logic.clsLocalDrivingLicenseApplicationLogic.GetAllLocalDrivingLicenseApplications();
        ...
        {
            _LoadDataGridView($"Convert({ctrFiltredList1.Item}, 'System.String') LIKE '%{obj}%'");
        }
