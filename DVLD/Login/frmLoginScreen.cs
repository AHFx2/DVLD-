...
namespace DVLD_Interface.Screens
{
    public partial class frmLoginScreen : Form
    {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                if (user.IsActive)
                {
                    ...
                    {
                        clsGlobal.RememberPasswordAndUserName(txtUserName.Text.Trim(), txtPassWord.Text.Trim());
                    }
                    else
                        clsGlobal.RememberPasswordAndUserName("", ""); // actuly this will not save empty data but will delete the file data
        ...
        private void frmLoginScreen_Load(object sender, EventArgs e)
        {
            ...
            if (clsGlobal.GetStoredCardintls(ref temUsername, ref temPassword))
            {
