...
namespace DVLD_Interface.Controls.ctrLicenses
{
    public partial class ctrReleaseDetainedLicense : UserControl
    {
        ...
        private void _FillAppInfo()
        {
            ...
            //application.ApplicationTypeID = Convert.ToByte(clsApplication.enApplicationType.ReleaaseDetainedLicense);
            //application.ApplicationStatus = 1;
            //application.LaststautDate = DateTime.Now;
            //application.ApplicationDate = DateTime.Now;
            //application.UserCreatIt = clsGloble.User.ID;
            //lblAppFees.Text = clsApplicationType.GetApplicationType(Convert.ToByte(clsApplication.enApplicationType.ReleaaseDetainedLicense)).Fees.ToString();
