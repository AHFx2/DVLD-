...
namespace DVLD_Interface.Controls.ctrMISC
{
    public partial class ctrAddLocalLicenseApp : UserControl
    {
        ...
        public void Initialize()
        {
            ...
            lblUser.Text = clsGlobal.User.Username;
            lblUser.Tag = clsGlobal.User.ID;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //if (!clsLocalDrivingLicenseApplication.DosePersonHaveThisLicense(licenseApplication.Application.ApplicantPersonID, licenseApplication.LicenseClassID))
            //{
            //    if (!clsLocalDrivingLicenseApplication.IsThereActiveApplication(licenseApplication.Application.ApplicantPersonID, licenseApplication.LicenseClassID))
            //    {
