...
namespace DVLD_Interface.Controls.ctrMISC
{
    public partial class ctrDamged_LostLicensesApplications : UserControl
    {
        ...
        private void _FillApplicationInfo()
        {
            ...
            //lblFees.Text = clsApplicationType.GetApplicationType(application.ApplicationTypeID).Fees.ToString();
            //application.PaidFees = Convert.ToInt16(lblFees.Text);
            //application.ApplicantPersonID = clsPerson.GetPerson(Convert.ToInt16(this.ctrFindLicense2.ctrLincesCard1.LicenseInformation.Rows[0]["PersonID"])).ID;
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //    application.ApplicationTypeID = Convert.ToByte(clsApplication.enApplicationType.ReplaceDamgedLicense);
            //}

            //else
            //{
            //    lblTitlte.Text = "Replace Lost License Application";
            //    application.ApplicationTypeID = Convert.ToByte(clsApplication.enApplicationType.ReplaceLostLicense);
            //}
        ...
        private void _FillTheBoxInformation()
        {
            ...
            //lblFees.Text = clsApplicationType.GetApplicationType(Convert.ToByte(clsApplication.enApplicationType.NewIntrnationlLicense)).Fees.ToString();
