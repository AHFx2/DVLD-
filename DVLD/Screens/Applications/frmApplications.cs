...
namespace DVLD_Interface.Screens.MISC
{
    public partial class frmApplications : frmPerent2
    {
        ...
        {
            frmLocalDrvingLicenseApplicationsList frmLocalLicenseList = new frmLocalDrvingLicenseApplicationsList();
        ...
        {
            frmMangeApplicationsTypeList ApplicationsTypes = new frmMangeApplicationsTypeList();
        ...
        {
            frmLocalDrvingLicenseApplicationsList frm = new frmLocalDrvingLicenseApplicationsList();
            frm.ShowDialog();
        }
    }
}
