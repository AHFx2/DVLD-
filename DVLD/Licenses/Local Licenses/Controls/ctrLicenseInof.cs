...
{
    public partial class ctrLicenseInof : UserControl
    {
        private int _LicenseID;
        private clsLicense _License;

        public ctrLicenseInof()
        {
            InitializeComponent();
        ...
        public void LoadInfo(int LicenseID)
        {
            ...
            clsUtil.LoadPersonImage(this.SelectedLicenseInfo.DriverInfo.PersonInfo, pbPersonImage);
