...
namespace DVLD_Logic
{
    public class clsLicenseLogic
    {
        ...
        public clsDriverLogic DriverInfo;
        public int LicenseID { set; get; }
        public int ApplicationID { set; get; }
        public int DriverID { set; get; }
        public int LicenseClass { set; get; }
        public clsLicenseClassLogic LicenseClassIfo;
        ...
        public clsLicenseLogic(int LicenseID, int ApplicationID, int DriverID, int LicenseClass,
...

        {
            ...
            this.DriverInfo = clsDriverLogic.FindByDriverID(this.DriverID);
            this.LicenseClassIfo = clsLicenseClassLogic.GetLicenseByID(this.LicenseClass);
        ...
        public static clsLicenseLogic Find(int LicenseID)
        {
            ...
            ref PaidFees, ref IsActive, ref IssueReason, ref CreatedByUserID))
                ...
                return new clsLicenseLogic(LicenseID, ApplicationID, DriverID, LicenseClass,
        ...
        //    Application.PaidFees = clsApplicationType.GetApplicationType((int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicsense).Fees;
        ...
        public clsLicenseLogic RenewLicense(string Notes, int CreatedByUserID)
        {
            ...
            Application.ApplicantPersonID = this.DriverInfo.PersonID;
            Application.ApplicationDate = DateTime.Now;
            Application.ApplicationTypeID = (int)clsApplicationLogic.enApplicationType.RenewDrivingLicense;
            Application.ApplicationStatus = clsApplicationLogic.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationTypeLogic.GetApplicationType((int)clsApplicationLogic.enApplicationType.RenewDrivingLicense).Fees;
            ...
            clsLicenseLogic NewLicense = new clsLicenseLogic();
            ...
            NewLicense.IssueReason = clsLicenseLogic.enIssueReason.Renew;
        ...
        public clsLicenseLogic Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.ApplicationTypeID = (IssueReason == enIssueReason.DamagedReplacement) ?
                (int)clsApplicationLogic.enApplicationType.ReplaceDamagedDrivingLicense :
                (int)clsApplicationLogic.enApplicationType.ReplaceLostDrivingLicense;
